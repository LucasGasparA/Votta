  ...
  return (
    <motion.div
      ...
      className={`card-base p-4
        ${clickable
          ? 'cursor-pointer hover:border-primary-300 dark:hover:border-primary-700 hover:shadow-md hover:ring-2 hover:ring-primary-100 dark:hover:ring-primary-900/40'
          : ''
        }`}
    >
