...
const EditorMinuta = () => {
  ...
  return (
    <div className="h-screen flex flex-col bg-primary-50 dark:bg-dark-bg print:bg-white">
      {/* Top Bar */}
      <div className="bg-white dark:bg-dark-surface border-b border-primary-200 dark:border-dark-border px-3 md:px-6 py-3 flex-shrink-0 shadow-sm print:hidden">
        <div className="flex items-center justify-between gap-2 md:gap-4">
            ...
            <div className="min-w-0 flex items-center gap-2">
              {editandoTitulo ? (
                <input
                  ...
                  className="text-base font-semibold text-primary-800 dark:text-slate-100 bg-primary-50 dark:bg-dark-elevated
                    border-b-2 border-primary-400 dark:border-dark-borderStrong outline-none px-1 min-w-0 w-48 md:w-64"
                  autoFocus
                />
              ) : (
                <button
          ...
          <div className="hidden md:flex items-center gap-1 px-3 py-1.5 bg-primary-50 dark:bg-dark-elevated rounded-lg border border-primary-100 dark:border-dark-borderStrong">
            {[
              ...
              <button
                ...
                className="p-1.5 rounded text-primary-500 dark:text-slate-400 hover:bg-white dark:hover:bg-dark-surface hover:text-primary-700 dark:hover:text-slate-200 hover:shadow-sm transition-all"
              >
                <Icon size={14} />
              </button>
            ))}
          ...
          <div className="flex items-center gap-2 flex-shrink-0">
            ...
            <button
              ...
              className="flex items-center gap-1.5 px-2.5 md:px-3 py-2 text-sm border border-primary-200 dark:border-dark-borderStrong text-primary-600 dark:text-slate-300 rounded-lg hover:bg-primary-50 dark:hover:bg-dark-elevated active:scale-[0.97] transition-all"
            >
              <History size={15} />
            ...
            <button
              onClick={aoSalvar}
              disabled={salvando}
              className="flex items-center gap-1.5 px-2.5 md:px-3 py-2 md:py-1.5 text-sm text-primary-600 dark:text-slate-300 hover:bg-primary-50 dark:hover:bg-dark-elevated border border-primary-200 dark:border-dark-borderStrong rounded-lg transition-all disabled:opacity-50"
            >
              <Save size={14} />
      ...
      <div className="flex flex-1 overflow-hidden print:block">
        ...
        <div className="flex-1 overflow-y-auto p-4 md:p-6 print:hidden">
          ...
          {/* Seção Nav */}
          <div className="rounded-lg border border-primary-100 bg-white p-2.5 mb-4 shadow-sm dark:bg-dark-surface dark:border-dark-border">
              ...
              {SECTIONS.map(({ id: sId, label, icon: Icon }) => (
                <button
                  ...
                  className={`flex items-center gap-1.5 px-3 py-2 rounded-lg text-sm font-medium whitespace-nowrap transition-all active:scale-[0.97]
                    ${secaoAtiva === sId ? 'bg-primary-100 text-primary-700 dark:bg-dark-elevated dark:text-slate-100' : 'text-primary-500 dark:text-slate-400 hover:bg-primary-50 dark:hover:bg-dark-elevated hover:text-primary-700 dark:hover:text-slate-200'}`}
                >
                  <Icon size={15} />
                  {label}
                </button>
            ...
            {validacoes.map((v, i) => (
              <motion.div
                ...
                className={`p-3 rounded-lg border-l-4 flex items-center gap-2.5 ${
                  v.type === 'success' ? 'bg-primary-50 dark:bg-dark-surface border-primary-400' : v.type === 'warning' ? 'bg-amber-50 border-amber-400' : 'bg-rosso-50 border-rosso-500'
                }`}
              >
                {v.type === 'success'
          ...
          {/* Conteúdo */}
          <div className="rounded-lg border border-primary-100 bg-white p-5 md:p-7 shadow-sm dark:bg-dark-surface dark:border-dark-border" key={chaveDoc}>
            {(() => {
              ...
              <div>
                <div className="flex items-center justify-between mb-4">
                  ...
                  <button onClick={adicionarArtigo}
                    className="flex items-center gap-1.5 px-3 py-1.5 text-sm bg-primary-100 dark:bg-dark-elevated text-primary-700 dark:text-slate-300 rounded-lg hover:bg-primary-200 dark:hover:bg-dark-border active:scale-[0.97] transition-all">
                    + Adicionar Artigo
                  </button>
                </div>
                {doc.artigos.length === 0 ? (
                  ...
                  <div className="space-y-4">
                    {doc.artigos.map(artigo => (
                      <div key={artigo.id} className="border border-primary-100 dark:border-dark-border rounded-xl p-5">
                        <div className="flex items-start gap-4">
                          <span className="px-2.5 py-1 bg-primary-100 dark:bg-dark-elevated text-primary-700 dark:text-slate-300 font-bold text-sm rounded flex-shrink-0 mt-1">{artigo.numero}</span>
                          <div className="flex-1">
                            <textarea key={`${chaveDoc}-${artigo.id}`} defaultValue={artigo.texto}
                              ...
                              className="w-full px-3 py-2.5 border-2 border-primary-100 dark:border-dark-border dark:bg-dark-elevated dark:text-slate-100 rounded-lg focus:border-primary-400 dark:focus:border-dark-borderStrong focus:outline-none font-serif text-sm min-h-[80px] resize-none transition-colors"
        ...
        {(() => {
          ...
          return (
            <aside className="hidden xl:flex flex-col w-64 border-l border-primary-200 dark:border-dark-border bg-white dark:bg-dark-surface overflow-y-auto flex-shrink-0 print:hidden">
              <div className="p-4 border-b border-primary-100 dark:border-dark-border">
      ...
      <AnimatePresence>
        {chatAberto && (
          <motion.div
            ...
            className="fixed bottom-24 right-6 w-[340px] bg-white dark:bg-dark-surface rounded-2xl shadow-2xl border border-primary-100 dark:border-dark-border flex flex-col overflow-hidden z-50 print:hidden"
            ...
            <AnimatePresence initial={false}>
              {!minimizado && (
                ...
                >
                  ...
                  <div className="flex-1 overflow-y-auto p-3 space-y-3 min-h-0">
                    ...
                    {historicoChat.length === 0 && !carregandoChat && (
                      <div className="flex flex-col h-full">
                        <div className="flex-1 flex flex-col items-center justify-center gap-3 pb-2">
                          <div className="w-12 h-12 bg-primary-100 dark:bg-dark-elevated rounded-2xl flex items-center justify-center">
                        ...
                        <div className="grid grid-cols-2 gap-1.5">
                          {quickSuggestions.map((s, i) => (
                            <motion.button
                              ...
                              className="text-left px-2.5 py-2 bg-primary-50 dark:bg-dark-elevated hover:bg-primary-100 dark:hover:bg-dark-border border border-primary-100 dark:border-dark-borderStrong hover:border-primary-200 rounded-xl text-[11px] text-primary-700 dark:text-slate-300 leading-tight transition-all"
                            >
                              {s}
                            </motion.button>
                          ))}
                    ...
                    {historicoChat.map((msg, i) => {
                      if (msg.role === 'user') return (
                        <div key={i} className="flex justify-end items-end gap-1.5">
                          ...
                          <div className="w-6 h-6 bg-primary-100 dark:bg-dark-elevated rounded-full flex items-center justify-center flex-shrink-0 text-[9px] font-bold text-primary-600 dark:text-slate-300">
                            EU
                          </div>
                        </div>
                      )
                      ...
                      return (
                        <div key={i} className="flex justify-start items-end gap-1.5">
                          <div className="w-6 h-6 bg-primary-100 dark:bg-dark-elevated rounded-full flex items-center justify-center flex-shrink-0">
                          ...
                          <div className={`rounded-2xl rounded-bl-sm px-3 py-2 text-xs max-w-[80%] leading-relaxed ${
                            msg.hasCit
                              ...
                              : 'bg-white dark:bg-dark-elevated border border-primary-100 dark:border-dark-borderStrong text-primary-800 dark:text-slate-200 shadow-sm'
                          }`}>
                            {msg.hasCit && (
                    ...
                    {carregandoChat && (
                      <div className="flex justify-start items-end gap-1.5">
                        ...
                        <div className="bg-white dark:bg-dark-elevated border border-primary-100 dark:border-dark-borderStrong rounded-2xl rounded-bl-sm px-3 py-2.5 shadow-sm max-w-[80%]">
                  ...
                  {/* Input */}
                  <div className="p-3 border-t border-primary-100 dark:border-dark-border flex-shrink-0 bg-primary-50/50 dark:bg-dark-elevated/50">
                    <div className="flex gap-2 items-end">
                      <div className="flex-1">
                        ...
                        <textarea
                          ...
                          className="w-full px-3 py-2 border-2 border-primary-200 dark:border-dark-borderStrong dark:bg-dark-surface dark:text-slate-100 rounded-xl focus:border-primary-500 dark:focus:border-dark-borderStrong focus:outline-none text-xs transition-colors resize-none leading-relaxed"
        ...
        {exibirModalVersoes && (
          ...
          >
            <motion.div
              ...
              className="bg-white dark:bg-dark-surface rounded-2xl shadow-xl max-w-md w-full mx-4 flex flex-col max-h-[80vh]"
            >
              <div className="flex items-center justify-between p-5 border-b border-primary-100 dark:border-dark-border flex-shrink-0">
                ...
                <button
                  ...
                  className="text-primary-400 dark:text-slate-500 hover:text-primary-600 dark:hover:text-slate-300 p-1.5 rounded-lg hover:bg-primary-50 dark:hover:bg-dark-elevated transition-colors"
                >
                  <X size={18} />
                </button>
              </div>
              <div className="overflow-y-auto flex-1 p-4">
                {carregandoVersoes ? (
                  <div className="space-y-3">
                    {[0, 1, 2].map(i => (
                      <div key={i} className="animate-pulse flex items-center justify-between p-3 rounded-xl bg-primary-50 dark:bg-dark-elevated">
                        <div className="space-y-2 flex-1">
                          <div className="h-3 bg-primary-200 dark:bg-dark-border rounded w-24" />
                          <div className="h-2.5 bg-primary-100 dark:bg-dark-border rounded w-36" />
                        </div>
                        <div className="h-7 w-20 bg-primary-100 dark:bg-dark-border rounded-lg" />
                      </div>
                    ))}
                  </div>
                ) : versoes.length === 0 ? (
                  ...
                  return (
                    <div className="space-y-2">
                      {versoes.map(v => (
                        <div key={v.id} className="border border-primary-100 dark:border-dark-border rounded-xl p-3">
                          <div className="flex items-center justify-between gap-3">
                            ...
                            {v.versionNumber !== maxV && confirmandoVersaoId !== v.id && (
                              <button
                                ...
                                className="flex-shrink-0 text-xs px-3 py-1.5 rounded-lg border border-primary-200 dark:border-dark-borderStrong text-primary-600 dark:text-slate-300 hover:bg-primary-50 dark:hover:bg-dark-elevated active:scale-[0.97] transition-all"
                              >
                                Restaurar
                              </button>
                            )}
                          ...
                          {confirmandoVersaoId === v.id && (
                            <div className="mt-3 pt-3 border-t border-primary-100 dark:border-dark-border">
                              ...
                              <div className="flex gap-2">
                                <button
                                  ...
                                  className="flex-1 text-xs py-1.5 rounded-lg border border-primary-200 dark:border-dark-borderStrong text-primary-600 dark:text-slate-300 hover:bg-primary-50 dark:hover:bg-dark-elevated transition-all"
                                >
                                  Cancelar
                                </button>
                                <button
      ...
      <AnimatePresence>
        {exibirModalExportacao && (
          ...
          >
            <motion.div
              initial={{ scale: 0.95, y: 16 }} animate={{ scale: 1, y: 0 }} exit={{ scale: 0.95, y: 16 }}
              className="bg-white dark:bg-dark-surface rounded-2xl shadow-2xl w-full max-w-lg"
            >
              <div className="flex items-center justify-between p-6 border-b border-primary-100 dark:border-dark-border">
                ...
                <button onClick={() => setExibirModalExportacao(false)} className="text-primary-400 dark:text-slate-500 hover:text-primary-600 dark:hover:text-slate-300 p-1.5 rounded-lg hover:bg-primary-50 dark:hover:bg-dark-elevated">
                  <X size={20} />
                </button>
              </div>
              <div className="p-6 space-y-4">
                <div className="bg-primary-50 dark:bg-dark-elevated rounded-xl p-4">
                ...
                <div>
                  ...
                  {alertasPendentes.length === 0 ? (
                    <div className="flex items-center gap-2 text-primary-600 dark:text-slate-200 bg-primary-50 dark:bg-dark-elevated border border-primary-200 dark:border-dark-borderStrong rounded-xl px-3 py-3 text-sm">
                    ...
                    <div className="space-y-1.5">
                      {alertasPendentes.map((v, i) => (
                        <div key={i} className="flex items-start gap-2 text-primary-600 dark:text-slate-300 bg-primary-50 dark:bg-dark-elevated border border-primary-100 dark:border-dark-border rounded-lg px-3 py-2.5 text-xs">
                ...
                <label className={`flex items-start gap-3 cursor-pointer p-4 border-2 rounded-xl transition-all hover:bg-primary-50 dark:hover:bg-dark-elevated ${
                  exportacaoRevisada ? 'border-primary-500' : 'border-primary-100 dark:border-dark-borderStrong'
                }`}>
              ...
              <div className="flex gap-3 p-6 pt-0">
                <button onClick={() => setExibirModalExportacao(false)}
                  className="flex-1 py-2.5 rounded-xl text-sm font-medium border border-primary-200 dark:border-dark-borderStrong text-primary-600 dark:text-slate-300 hover:bg-primary-50 dark:hover:bg-dark-elevated active:scale-[0.97] transition-all">
                  Voltar ao Editor
                </button>
            ...
            >
              ...
              <div className="flex flex-col gap-2">
                ...
                <button
                  ...
                  className="w-full py-2.5 rounded-xl text-sm font-medium border border-primary-200 dark:border-dark-borderStrong
